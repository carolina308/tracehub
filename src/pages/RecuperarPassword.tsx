    ...
    <div className="min-h-[100dvh] flex">
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-6 bg-white">
        <div className="w-full max-w-sm">
          ...
          <button type="button" onClick={() => navigate('/login')} className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 mb-6 transition">
            <ArrowLeft size={15} />
            Volver al inicio
          </button>

          <h2 className="text-xl font-bold text-gray-900 mb-1">Recuperar contraseña</h2>
          <p className="text-gray-500 text-sm mb-6">Ingresá tu correo y te enviaremos instrucciones</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input id="email" type="email" value={correo} onChange={(e) => setCorreo(e.target.value)} required placeholder="tu@correo.com" className="block w-full rounded-xl border border-gray-200 pl-9 pr-3.5 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20 transition-all duration-300" />
              </div>
            </div>

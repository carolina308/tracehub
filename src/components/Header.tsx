  ...
  return (
    <header className="w-full flex items-center justify-between bg-white px-3 py-2 border-b border-slate-200/50">
      ...
      <div className="flex items-center gap-1">
        <Link to="/settings" className="p-1 rounded-full text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-all duration-300 hover:scale-110">
          <Settings size={14} />
        </Link>
        <button className="p-1 rounded-full text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-all duration-300 hover:scale-110">
          <FiBell size={14} />
        </button>
